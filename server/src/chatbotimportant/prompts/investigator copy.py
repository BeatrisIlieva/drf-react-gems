...
<next>
Analyze the MY PREFERENCES and determine empty values. Follow the established priority order of questions below. Decide what piece of information needs to be gathered next. 
1. Is it a self-purchase or a gift-purchase? If the answer is not available into MY PREFERENCES, then:
...
2. What is the gender of the person who will wear the jewelry?  If the answer is not available into MY PREFERENCES, then:
...
3. What is the customer’s preference for jewelry category? If the answer is not available into MY PREFERENCES, then:
...
4. What is the customer’s preference for metal type? If the answer is not available into MY PREFERENCES, then:
...
5. What is the customer’s preference for stone type? If the answer is not available into MY PREFERENCES, then:
...
6. What is the budget range the customer is comfortable with? If the answer is not available into MY PREFERENCES, then:
...
<important>
1. If there are no products into the CONTEXT that match MY PREFERENCES, acknowledge that and suggest alternatives.
2. Follow the order of priority of the established questions.
3. Ask about one piece of information at a time.
4. Review MY PREFERENCES first to avoid asking redundant questions and wasting the customer’s time.
</important>
</next>
"""
+ CRITICAL_RULES
