            ...
            },
            {
                ...
                'items': [
                    ...
                    },
                    {
                        ...
                        'icon': 'shopping_bag',
                        'link': reverse_lazy('admin:shopping_bags_shoppingbag_changelist'),
                        'permission': lambda request: request.user.has_perm('shopping_bags.view_shoppingbag'),
                    },
                    {
                        'title': _('Orders'),
                        'icon': 'shopping_cart',
                    ...
                    },
                    {
                        'title': _('Wishlists'),
                        'icon': 'favorite',
                        'link': reverse_lazy('admin:wishlists_wishlist_changelist'),
                        'permission': lambda request: request.user.has_perm('wishlists.view_wishlist'),
                    },
                ],
            },
        ],
