    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('street_address', models.ForeignKey(null=True, on_delete=django.db.models.deletion.CASCADE, to='accounts.streetaddress')),
                ('zip_code', models.ForeignKey(null=True, on_delete=django.db.models.deletion.CASCADE, to='accounts.zipcode')),
            ],
        ),
    ]
