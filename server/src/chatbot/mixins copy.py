...
class OfferSizeHelp:
    def handle_offer_size_help(self, llm, conversation_memory, conversation_insights, customer_query):
        return generate_formatted_response(
            llm,
...
class ProvideSizeHelp:
    def handle_provide_size_help(self, llm, conversation_memory, conversation_insights, customer_query):
        return generate_formatted_response(
            llm,
