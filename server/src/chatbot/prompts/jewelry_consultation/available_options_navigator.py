from src.chatbot.prompts.base import CONTEXT, CRITICAL_RULES, DO_NOT_RECOMMEND_PRODUCT, GOAL, NEXT, ROLE_CONCISE, WHO_AM_I
...
""" 
<task>
I have expressed specific preferences, but no exact matches were found in the CONTEXT. Your task is to gracefully guide me toward your available pieces while maintaining my core desires. Do not recommend products to me; instead, ask a question that prompts me to reconsider my initial request.
