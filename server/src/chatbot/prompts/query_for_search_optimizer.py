...
- Choose only between the following metal types: ['rose gold', 'yellow gold', 'gold', 'platinum']
...
- Choose only between the following stone types: ['sapphire', 'pink sapphire', 'blue sapphire', 'yellow sapphire', 'aquamarine', 'emerald', 'ruby', 'diamond', 'white diamond']
