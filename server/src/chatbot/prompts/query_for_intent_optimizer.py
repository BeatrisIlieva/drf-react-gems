...
<goal>
The goal is to identify what the customer truly wants by analyzing the STATEMENT, then express that need as a single, well-formed question.
</goal>

<task>
- Focus on terms, concepts, and phrases that are likely to match the chunked content while maintaining the customer's original intent expressed into the STATEMENT
