...
class WishlistSerializerTestCase(TestCase):
    ...
    def test_serializer_read_only_fields(self):
        ...
        expected_read_only_fields = [
            'id', 'created_at', 'user', 'guest_id', 'product_info'
        ]
    ...
    def test_serializer_content_type_field(self):
        ...
        self.assertEqual(data['content_type'], 'earwear')
    ...
    def test_serializer_validation_valid_data(self):
        ...
        This test verifies that the serializer accepts valid data
        and properly validates it.
        """
        # Arrange
        valid_data = {
            'content_type': 'earwear',  # Use string instead of ContentType object
    ...
    def test_product_info_average_rating(self):
        ...
        self.assertIsInstance(product_info['average_rating'], (int, float, type(None)))
    ...
    def test_product_info_price_range(self):
        ...
        self.assertIsInstance(product_info['min_price'], (int, float, Decimal, type(None)))
        self.assertIsInstance(product_info['max_price'], (int, float, Decimal, type(None)))
    ...
    def test_serializer_depth_configuration(self):
        """
        Test that serializer has correct configuration.
        ...
        # Act & Assert
        # Check that the serializer has the expected Meta configuration
