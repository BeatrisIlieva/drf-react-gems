...
6.  Payment form [server/src/orders/serializers.py](https://github.com/beatrisilieva/drf-react-gems/blob/main/server/src/orders/serializers.py)
7.  Product review form [server/src/products/serializers/review.py](https://github.com/beatrisilieva/drf-react-gems/blob/main/server/src/products/serializers/review.py)
