...
export const Home = () => {
    return (
        <section className={styles['home']}>
            <div
                className={`${styles['thumbnail']} ${styles['wrapper-top']}`}
            >
                <div className={styles['hero-text']}>
                    <h2>Rare Jewels of the World</h2>
                    <p>
                        Featuring the finest diamonds and most
                        precious gemstones, our jewelry creations
                        epitomize creativity, rarity and quality
                        without compromise.
                    </p>
                </div>
                <img
