                        ...
                        {bagInfo.map(item => (
                            <div key={item.id} className={styles['grid-item']}>
                                <div className={styles['item-row']}>
                                    ...
                                    <span className={styles['item-value id-value']}>{item.id}</span>
                                </div>
                                <div className={styles['item-row']}>
                                ...
                                <div className={styles['item-row']}>
                                    <span className={styles['item-label']}>Total Price</span>
                                    <span className={styles['item-value price-value']}>
                                        {formatPrice(item.total_price)}
                                    </span>
                                </div>
                                <div className={styles['item-row']}>
                                    <span className={styles['item-label']}>Product Info</span>
                                    <span className={styles['item-value']}>
                                        {item.product_info}
                                    </span>
                                </div>
