...
export const Login: React.FC = () => {
    ...
    const { userData, validateFields, validateField, handleFieldChange, setServerSideError, getInputClassName } =
    ...
    const loginHandler = async () => {
        ...
        Object.keys(initialFormValues).forEach((key) => {
            if (authData && typeof authData === 'object') {
                setServerSideError(authData as Record<string, string[]>, key);
            }
        });
