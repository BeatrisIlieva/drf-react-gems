...
export const validators = {
    ...
    password: {
        ...
        upper: (password) =>
            /[A-Z]/.test(password) ? "" : AUTH_ERROR_MESSAGES.PASSWORD,

        lower: (password) =>
            /[a-z]/.test(password) ? "" : AUTH_ERROR_MESSAGES.PASSWORD,

        number: (password) =>
            /\d/.test(password) ? "" : AUTH_ERROR_MESSAGES.PASSWORD,

        noSpaces: (password) =>
            !/\s/.test(password) ? "" : AUTH_ERROR_MESSAGES.PASSWORD,

        special: (password) =>
            /[!#$%]/.test(password) ? "" : AUTH_ERROR_MESSAGES.PASSWORD,
    },
    firstName: {
        isValid: (value) =>
            new RegExp(
    ...
    cardNumber: {
        isValid: (value) => {
            ...
            const isValid = Object.values(PAYMENT_CONSTANTS.CARD_PATTERNS).some(
    ...
    cardHolderName: {
        isValid: (value) => {
            ...
            if (
                !new RegExp(PAYMENT_CONSTANTS.CARD_HOLDER_PATTERN).test(value)
            ) {
                return PAYMENT_CONSTANTS.ERRORS.CARD_HOLDER;
            }
    ...
    expiryDate: {
        isValid: (value) => {
            ...
            if (
                !new RegExp(PAYMENT_CONSTANTS.EXPIRY_DATE_PATTERN).test(value)
            ) {
